...
//            driver = new FirefoxDriver(firefoxOptions);
    ...
    public static WebElement getDate1(String locator) throws InterruptedException, IOException {
        WebElement dateWidgetFrom = chooseElement(locator);
		...
		return dateWidgetFrom;
    }
    
    public static String getDate(String locator ) throws InterruptedException, IOException{
    	WebElement returnDate = chooseElement(locator);
